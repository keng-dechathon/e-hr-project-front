...
const CardPersonalInfo = () => {
  ...
  const setDataInfo = () => {
    personalData.push({
      title: "Title",
      value: accountInformation.Title ? accountInformation.Title : notSet,
    });
    personalData.push({
      title: "Full name",
      value:
        accountInformation.Firstname && accountInformation.Lastname
          ? capitalizeFirstLetter(accountInformation.Firstname) +
            " " +
            capitalizeFirstLetter(accountInformation.Lastname)
          : notSet,
    });
    personalData.push({
      title: "Gender",
      value: accountInformation.Gender ? accountInformation.Gender : notSet,
    });
    personalData.push({
      title: "Date of Birth",
      value: accountInformation.BirthDate
        ? getDateFormat2(accountInformation.BirthDate)
        : notSet,
    });
  };
