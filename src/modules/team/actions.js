...
export const GET_TEAMS_INFORMATION = createRequestTypes(Types.GET_TEAMS_INFORMATION)
export const GET_MEMBERS_INFORMATION = createRequestTypes(Types.GET_MEMBERS_INFORMATION)

export const getTeamsInformation = (config, data = {}) =>
    createAction(GET_TEAMS_INFORMATION.REQUEST, {}, {
        method: 'POST',
...
export const getMemberInformation = (config, data = {}, id) =>
    createAction(GET_MEMBERS_INFORMATION.REQUEST, { Option: "Member", Team_id: id }, {
        method: 'POST',
        url: apiUrl.eHRService.common.team,
        params: data,
        ...config
