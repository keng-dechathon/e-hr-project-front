                    ...
                    <Box sx={{ padding: '20px', bgcolor: '#F7F0F3', display: 'flex' }}>
                        ...
                        <div className={classes.headername}>
                            <Typography variant='h6' fontWeight='bold'>
                                {
                                    empInformationByID.length !== 0 ? empInformationByID.Firstname + ' ' + empInformationByID.Lastname
                                        :
                            ...
                            <Typography variant='subtitle1' color='mute' fontWeight='meduim'>
                                {
                                    empInformationByID.length !== 0 ? empInformationByID.Company + ' • ' + empInformationByID.Position
                                        :
                                        <Skeleton width={'100%'} height={40} animation="wave" />
                                }
                            </Typography>
