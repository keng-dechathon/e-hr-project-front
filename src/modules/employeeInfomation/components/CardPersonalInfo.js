...
const CardPersonalInfo = (props) => {
  ...
  const setDataInfo = () => {
    personalData.push({
      title: "Title",
      value: empInformationByID.Title ? empInformationByID.Title : notSet,
    });
    personalData.push({
      title: "Full name",
      value:
        empInformationByID.Firstname && empInformationByID.Lastname
          ? capitalizeFirstLetter(empInformationByID.Firstname) +
            " " +
            capitalizeFirstLetter(empInformationByID.Lastname)
          : notSet,
    });
    personalData.push({
      title: "Gender",
      value: empInformationByID.Gender ? empInformationByID.Gender : notSet,
    });
    personalData.push({
      title: "Date of Birth",
      value: empInformationByID.BirthDate
        ? getDateFormat2(empInformationByID.BirthDate)
        : notSet,
    });
  };
    ...
    <>
      ...
      <Card className={classNames(classes.card, classes.margintop)}>
        <CardHeader
          ...
          title={<div className={classes.headerText}>Personal Information</div>}
