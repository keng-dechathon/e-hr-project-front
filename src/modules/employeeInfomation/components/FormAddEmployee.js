...
const FormAddEmployee = (props) => {
    ...
    useEffect(() => {
        setTimeout(() => setUser({ Comp_ID: company, Position_ID: position, Lastname: lastname, Title: title, Gender: gender, Firstname: firstname, Role: role, BirthDate: getDateFormat(date), Email: email }))
    }, [company, position, lastname, title, gender, firstname, role, date, email])
