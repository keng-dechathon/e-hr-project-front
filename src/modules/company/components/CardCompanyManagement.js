...
import FormCompanyManagement from "./FormCompanyManagement";
...
const CardCompanyManagement = () => {
  ...
  const setDataGrid = () => {
    if (Object.keys(AllCompanyInformation).length !== 0) {
      AllCompanyInformation.data.map((item, index) => {
        Info.push(item);
...
export default CardCompanyManagement;
