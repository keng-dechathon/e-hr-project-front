...
export const GET_HOLIDAYS_INFORMATION = createRequestTypes(
  Types.GET_HOLIDAYS_INFORMATION
);

export const GET_WORKINGTIME_INFORMATION = createRequestTypes(
  Types.GET_WORKINGTIME_INFORMATION
);
export const GET_DAYOFF_INFORMATION = createRequestTypes(
  Types.GET_DAYOFF_INFORMATION
);

export const getHolidaysInformation = (config, data = {}) =>
  createAction(
    GET_HOLIDAYS_INFORMATION.REQUEST,
    {},
    {
      method: "POST",
...
export const getWorkingTimeInformation = (config, data = {}) =>
  createAction(
    GET_WORKINGTIME_INFORMATION.REQUEST,
    {},
    {
      method: "POST",
...
export const getDayOffInformation = (config, data = {}) =>
  createAction(
    GET_DAYOFF_INFORMATION.REQUEST,
    {},
    {
      method: "POST",
